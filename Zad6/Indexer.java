    ...
    private void indexDocuments()
    {
        ...
        // ----------------------------------
            ...
            try {
                ...
                System.out.println("You can't open a directory");
            }
    ...
    private Document getHTMLDocument(String path, int id)
    {
        ...
        */
        ...
        // ----------------------------------
            ...
            IntPoint fileSizeField = new IntPoint(Constants.filesize, fileSize);
        ...
        // ----------------------------------
            ...
            StoredField storedSizeField = new StoredField(Constants.filesize, fileSize);
